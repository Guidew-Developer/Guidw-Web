      ...
      <main className="flex-grow">
        <section className="bg-white py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-sm text-brand-teal uppercase tracking-[0.3em] mb-4">Join The Mission</p>
            <h1 className="text-4xl md:text-5xl font-bold text-brand-darkBlue mb-6">与 Guidew 一起重新定义线下技能共享</h1>
